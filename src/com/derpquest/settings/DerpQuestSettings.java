...
import com.derpquest.settings.tabs.ActionsTab;
import com.derpquest.settings.tabs.InterfaceTab;
import com.derpquest.settings.tabs.StatusBarTab;
import com.derpquest.settings.tabs.LockScreenTab;
import com.derpquest.settings.tabs.SystemMiscTab;

import com.derpquest.settings.navigation.BubbleNavigationConstraintView;
import com.derpquest.settings.navigation.BubbleNavigationChangeListener;
...
//    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.derpquest, container, false);

        ActionBar actionBar = getActivity().getActionBar();
        if (actionBar != null) {
            actionBar.setTitle(R.string.derpquest_title);
        }

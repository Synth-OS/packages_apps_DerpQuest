...
public class AboutSynth extends DialogFragment {

    public static final String TAG_ABOUT_SYNTH = "AboutSynth";
    ...
    public static AboutSynth newInstance() {
        return new AboutSynth();
    }
    ...
    public View onCreateView(
        ...
        view = inflater.inflate(R.layout.about_synth, container, false);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        view = (inflater.inflate(R.layout.about_synth, null));
